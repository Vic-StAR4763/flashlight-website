...
const navigation = [
  ...
  { name: "Funeral Services", href: "/funerals" },
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 lg:px-8">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="font-serif text-xl font-bold text-primary">Flashlight Live Events</span>
          </Link>
        </div>
      ...
      {mobileMenuOpen && (
        <Portal.Root>
          <div className="lg:hidden fixed inset-0 z-[100]">
            ...
            <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-card px-6 py-6 sm:max-w-sm border-l border-border shadow-xl">
